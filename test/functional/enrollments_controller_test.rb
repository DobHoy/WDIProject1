...
class EnrollmentsControllerTest < ActionController::TestCase
  ...
  test "should create enrollment" do
    assert_difference('Enrollment.count') do
      post :create, enrollment: { enrollment_date: @enrollment.enrollment_date, has_paid: @enrollment.has_paid, prework_done: @enrollment.prework_done }
    end
  ...
  test "should update enrollment" do
    put :update, id: @enrollment, enrollment: { enrollment_date: @enrollment.enrollment_date, has_paid: @enrollment.has_paid, prework_done: @enrollment.prework_done }
    assert_redirected_to enrollment_path(assigns(:enrollment))
  end
